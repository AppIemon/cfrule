...
export const SEARCH_A_CLASS_SET = new Set('갓갸걱것겔굿궈귿긔께꼰꼽꾀꿰끌낚낟낫냅냐냠냥넥넬녁녈녑놋뇽뉘뉵늪닌님닙닝댱덜덴뎍뎐뎨돛됨됴듀듁딕딥딱땀뚜뚱뜨뜽랄랏랒랓램랫렉렙렷롄롯룬룰뤼를릊릎릭릿맴멘멜멧몫몬뮤믈뱀벅뵈빨뻘뽀섹셀셉션셩셰솝솥숯슐싁쌈썩쎄쏠쐬쑹쒜씰앗얌얘엠엥옌옴옻왁왓웰윷잭잼쟘쟝젤젹젼죡쥔즘짚쩡쭈찐찔찜쵸춤칡캡컨컷켐콕콘쿤퀴퀸킬킷킹탱텁톰툴튜팀팜팡팩팬펄펙펠폰햄헨헬혀혹홈홉홰훠훤');

const JOB_TOOLS = {
  해커: { attack: ['조작', '복제', '초토화'], defense: ['복제'], force: ['초토화'] },
  투자자: { attack: ['조작', '도박'], defense: [], force: [] },
  환자: { attack: ['환각증'], defense: ['환각증'], force: ['환각증'] },
  수집가: { attack: ['제작', '채굴'], defense: ['제작'], force: ['제작'] },
  감시자: { attack: ['탐지'], defense: ['탐지'], force: [] },
  뜀틀선수: { attack: ['뜀틀', '허들 넘기'], defense: ['뜀틀'], force: ['뜀틀'] },
  전우치: { attack: ['직격뢰'], defense: ['잔상'], force: ['직격뢰'] },
  기관사: { attack: ['폭주기관차'], defense: [], force: ['운행'] },
  늑대인간: { attack: [], defense: [], force: [] },
  시프터: { attack: ['시프트', '빅 시프트'], defense: ['시프트', '빅 시프트'], force: ['시프트', '빅 시프트'] },
  비밀요원: { attack: ['포획'], defense: ['포획'], force: ['포획'] },
  '67': { attack: [], defense: [], force: [] },
  사과: { attack: ['사구아'], defense: [], force: ['사과 디버프'] },
  시인: { attack: ['2음절', '유도음절', '시적 허용'], defense: ['시적 허용'], force: ['2음절'] },
  공룡: { attack: ['삼키기', '브레스', '꼬리 날리기'], defense: ['삼키기'], force: ['브레스'] },
  마법사: { attack: ['공허', '폭발'], defense: ['공허'], force: ['공허'] },
  사신: { attack: ['사형 선고', '영혼'], defense: ['영혼'], force: ['사형 선고'] },
  피보나치: { attack: ['뤼카 수열'], defense: [], force: [] },
  '?': { attack: ['?', '물음표', '쉼표'], defense: ['물음표', '쉼표'], force: ['쉼표'] },
  수학자: { attack: ['계산', '덧셈', '뺄셈', '곱셈', '교정', '미적분'], defense: [], force: ['논문 발표'] },
  과학자: { attack: ['DNA파괴'], defense: [], force: ['실험'] },
  갈릴레오: { attack: [], defense: [], force: ['관측'] },
  작곡가: { attack: ['쪼개기', '쉼표'], defense: ['쉼표'], force: ['작곡'] },
  스폰지밥: { attack: ['게살버거', '감자튀김', '보너스', '강도 채용'], defense: ['게살버거', '감자튀김'], force: ['게살버거', '감자튀김'] },
  나이트: { attack: ['체크메이트', '교환', '울음'], defense: ['교환'], force: ['체크메이트'] },
  생존자: { attack: ['아이쿠', '긴급 구조'], defense: ['긴급 구조'], force: ['신호'] },
  악당: { attack: ['결계', '왜곡'], defense: ['결계'], force: ['결계'] },
  기자: { attack: ['거짓 보도', '거짓 뉴스'], defense: ['거짓 보도'], force: ['거짓 보도'] },
  검객: { attack: ['찌르기', '가르기'], defense: ['가르기'], force: ['찌르기', '가르기'] },
  마하트마간디: { attack: ['억제'], defense: ['억제'], force: ['비폭력'] },
  은하계전사: { attack: [], defense: [], force: ['끝루트'] },
  혜성전사: { attack: [], defense: [], force: ['결계'] },
  수리사: { attack: ['수리'], defense: ['수리'], force: ['방탄'] },
  우라늄: { attack: ['핵분열'], defense: ['핵분열'], force: ['방사선'] },
  고죠: { attack: ['무량공처'], defense: ['무량공처'], force: ['무량공처'] },
  스핔이: { attack: ['물걸레질', '호박'], defense: ['물걸레질', '호박'], force: ['호박'] },
